...
public class Vector {
	 ...
	 * @return
	 */
	public static Vector random3D(final double xMin, final double xMax, final double yMin, final double yMax, final double zMin, final double zMax) {
		double x = Random.randomDouble(xMin, xMax);
		double y = Random.randomDouble(yMin, yMax);
	 ...
	 * @return
	 */
	public Vector constrain(final double xMin, final double xMax, final double yMin, final double yMax, final double zMin, final double zMax) {
	 ...
	 * @return
	 */
	public Vector constrain(final double xMin, final double xMax, final double yMin, final double yMax) {
		this.x = (this.x < xMin ? xMin : this.x > xMax ? xMax : this.x);
		this.y = (this.y < yMin ? yMin : this.y > yMax ? yMax : this.y);
		return this;
	}
	 ...
	 * @return
	 */
	public Vector constrain(final double xMin, final double xMax) {
		this.x = (this.x < xMin ? xMin : this.x > xMax ? xMax : this.x);
		return this;
	}
	 ...
	 * @return
	 */
	public Vector constrain(final Vector min, final Vector max) {
	 ...
	 * @return
	 */
	public Vector setMag(final double mag) {
		normalize();
		mult(mag);
		return this;
	}
	 ...
	 * @return
	 */
	public static double getScalar(final Vector vector, final Vector vector2) {
		return (vector.x * vector2.x + vector.y * vector2.y + vector.z * vector2.z);
	}
	 ...
	 * @return
	 */
	public double getScalar(final Vector vector) {
	 ...
	 * @return
	 */
	public static Vector getCenter(final Vector vector) {
	 ...
	 * @return
	 */
	public static Vector createVector(final double value) {
	 ...
	 * @return
	 */
	public static Vector createVector(final double x, final double y) {
	 ...
	 * @return
	 */
	public static Vector createVector(final double x, final double y, final double z) {
		return new Vector(x, y, z);
	}
	...
	/**
	 * Clear all the axes of the vector
	 */
	public Vector clear() {
		this.x = 0;
		this.y = 0;

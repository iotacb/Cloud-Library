...
public class Render {
	 ...
	 * @param vector
	 */
	public static void vertex(final Vector vector) {
	 ...
	 * @param vector
	 */
	public static void translate(final Vector vector) {
	 ...
	 * @param vector
	 */
	public static void scale(final Vector vector) {
	 ...
	 * @param angle
	 */
	public static void rotate(final Vector vector, final double angle) {
	...
	/**
	 * Draw a rectangle at a location with dimensions and set the rendering color
	 * @param x
	 * @param y
	 * @param width
	 * @param height
	 * @param color
	 */
	public static void drawRectangle(final double x, final double y, final double width, final double height, final Color color) {
		Render.color(color);
	 ...
	 * @param dimensions
	 */
	public static void drawRectangle(final Vector axes, final Vector dimensions) {
	 ...
	 * @param color
	 */
	public static void drawRectangle(final Vector axes, final Vector dimensions, final Color color) {
		drawRectangle(axes.x, axes.y, dimensions.x, dimensions.y, color);
	}
	...
	/**
	 * Draw a circle at a location with a radius and set the rendering color
	 * @param x
	 * @param y
	 * @param radius
	 * @param color
	 */
	public static void drawCircle(final double x, final double y, final double radius, final Color color) {
		Render.color(color);
	...
	public static void drawTriangle(final double x, final double y, final double sideLength, final double angle, final Color color) {
		Render.color(color);
		drawTriangle(x, y, sideLength, angle);
	}
	 ...
	 * @param angle
	 */
	public static void drawTriangle(final Vector axes, final double sideLength, final double angle) {
		drawTriangle(axes.x, axes.y, sideLength, angle);
	}
	
	/**
	 * Draw a triangle at a location with the side length and a rotate angle and set the rendering color
	 * @param axes
	 * @param sideLength
	 * @param angle
	 * @param color
	 */
	public static void drawTriangle(final Vector axes, final double sideLength, final double angle, final Color color) {
		drawTriangle(axes.x, axes.y, sideLength, angle, color);
	}
	...
	/**
	 * Draw a polygon at a location with a custom amount of sides, sidelength and a rotate angle and set the rendering color
	 * @param x
	 * @param y
	 * @param sides
	 * @param sideLength
	 ...
	 * @param color
	 */
	public static void drawPolygon(final double x, final double y, final int sides, final double sideLength, final double angle, final Color color) {
		Render.color(color);
		drawPolygon(x, y, sides, sideLength, angle);
	}
	 ...
	 * @param angle
	 */
	public static void drawPolygon(final Vector axes, final int sides, final double sideLength, final double angle) {
	 ...
	 * @param angle
	 */
	public static void drawPolygon(final Vector axes, final int sides, final double sideLength, final double angle, final Color color) {
		drawPolygon(axes.x, axes.y, sides, sideLength, angle, color);
	}
	 ...
	 * @return
	 */
	public static boolean canBeRendered(final Display display, final double x, final double y, final double width, final double height) {
		boolean can = true;

...
public class Input {
    ...
    public void update() {
        this.hasGamepad = glfwGetJoystickName(GLFW_JOYSTICK_1) != null;
        if (this.window.getLastMouseLocation().x != this.window.getMouseLocation().x || this.window.getLastMouseLocation().y != this.window.getMouseLocation().y) {

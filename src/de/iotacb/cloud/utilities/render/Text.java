...
public class Text {
	...
	public void drawText(Vector location, String text, Color color) {
		drawText((int)location.x, (int)location.y, text, color);
	}
	
	public void drawText(Vector location, String text) {
